...
func (_m *MockAuthenticator) Login(user string, password string) (string, error) {
...
//   - user string
//   - password string
func (_e *MockAuthenticator_Expecter) Login(user interface{}, password interface{}) *MockAuthenticator_Login_Call {
	return &MockAuthenticator_Login_Call{Call: _e.mock.On("Login", user, password)}
}

func (_c *MockAuthenticator_Login_Call) Run(run func(user string, password string)) *MockAuthenticator_Login_Call {
...
func (_c *MockAuthenticator_Login_Call) RunAndReturn(run func(string, string) (string, error)) *MockAuthenticator_Login_Call {
	_c.Call.Return(run)
	return _c
}
